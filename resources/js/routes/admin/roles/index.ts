...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::index
* @see app/Http/Controllers/UserManagement/RoleController.php:19
* @route '/admin/roles'
*/
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::create
* @see app/Http/Controllers/UserManagement/RoleController.php:27
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::store
* @see app/Http/Controllers/UserManagement/RoleController.php:37
* @route '/admin/roles'
*/
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::show
* @see app/Http/Controllers/UserManagement/RoleController.php:56
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::edit
* @see app/Http/Controllers/UserManagement/RoleController.php:66
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::update
* @see app/Http/Controllers/UserManagement/RoleController.php:78
* @route '/admin/roles/{role}'
*/
...
/**
* @see \App\Http\Controllers\UserManagement\RoleController::destroy
* @see app/Http/Controllers/UserManagement/RoleController.php:98
* @route '/admin/roles/{role}'
*/
