	...
	function setSelectedDate(inputDate, format) {
		...
		if (inputDate instanceof Array) dates = inputDate.map(function(d) {
			...
			case "multiple":
				...
				break;
			case "range": dates = inputDate.split(self.l10n.rangeSeparator).map(function(date) {
				return self.parseDate(date, format);
			});
		}
...
//#endregion
//#region node_modules/react-flatpickr/build/react-flatpickr.js
...
var M = (e) => {
	...
	(0, import_react.useImperativeHandle)(e.ref, () => ({ get flatpickr() {
		return t.current;
		...
		const i = () => {
			...
			}), t.current = (((a = flatpickr) == null ? void 0 : a.default) || flatpickr)(l.current, g), h?.(t.current);
		}, s = () => {
			m?.(t.current), t.current && t.current.destroy(), t.current = void 0;
		};
		return i(), () => {
			s();
		};
	...
	const x = (0, import_react.useCallback)((i) => {
		var s, a;
	...
	return o.wrap ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "flatpickr",
		ref: A,
		children: C
